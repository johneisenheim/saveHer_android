...
var scope = 'https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email'; //https://developers.google.com/accounts/docs/OAuth2Login
var state;
var devKey;
...
GoogleService.prototype.login = function(authSuccess_callback) {
	...
	Ti.App.Properties.removeProperty('GG_REFRESH_TOKEN');
...
function showAuthorizeUI(pUrl) {
	...
	window.addEventListener('androidback',function(){
		Ti.App.fireEvent('login_closed', {what:'google'});
