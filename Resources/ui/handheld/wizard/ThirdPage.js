function ThirdPage(){
	var SmallRectangleWizard3 = require('ui/handheld/rectangles/SmallRectangleWizard3');
	var SmallRectangleWizard4 = require('ui/handheld/rectangles/SmallRectangleWizard4');
	var SmallRectangleWizard5 = require('ui/handheld/rectangles/SmallRectangleWizard5');
	...
	self.add(smallRectangleWizard3);
	self.add(mailRecap);
	self.add(smallRectangleWizard4);
	self.add(smallRectangleWizard5);
	self.add(button);
	self.add(fakeView);
