function SmallRectangleWizard4(){
	...
	var rightIcon = Titanium.UI.createView({
		...
		height:30,
		backgroundColor:'#ffffff',
		backgroundImage:'/images/ic_icon_at.png',
		top:15,
		right:10
	});
	...
	container.setFieldValue = function(value){
		yetRegTextfield.value = value;
	};
...
module.exports = SmallRectangleWizard4;
