function MainPage(){
	...
	var SmallRectangleLogged1 = require('ui/tablet/rectangles/SmallRectangleLogged1');
	var SmallRectangleLogged2 = require('ui/tablet/rectangles/SmallRectangleLogged2');
	var TimeLine = require('ui/gtablet/timeline/Timeline');
	var timeLine = new TimeLine();
	var Report = require('ui/tablet/pages/Report');
	var Markers = require('ui/tablet/pages/Markers');
	var NewReport = require('ui/tablet/rectangles/NewReport'); 	 	
	var newReport = new NewReport(); 	 	
	var ShowMarkers = require('ui/tablet/rectangles/ShowMarkers'); 	 	
