function Report(){
	...
	var ReportRectangle = require('ui/tablet/rectangles/ReportRectangle');
	var reportRectangle = new ReportRectangle();
	var NetworkRectangle = require('ui/tablet/rectangles/NetworkRectangle');
	var networkRectangle = new NetworkRectangle();
	var GPSRectangle = require('ui/tablet/rectangles/GPSRectangle');
	var gpsRectangle = new GPSRectangle();
	var Buttons = require('ui/tablet/ui_elements/Buttons');
	var MainPage = require('ui/tablet/pages/MainPage');
