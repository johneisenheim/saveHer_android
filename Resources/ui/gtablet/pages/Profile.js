function Profile(len){
	...
	if( repDirLen > 0 ){
		var ProfileReportsRectangle = require('ui/gtablet/rectangles/ProfileReportsRectangle');
		profileRectangle = new ProfileReportsRectangle();
	}else{
		var ProfileRectangle = require('ui/gtablet/rectangles/ProfileRectangle');
		...
		cdialog.addEventListener('click', function(e){
			if ( e.index == 0 ){
				...
				setTimeout(function(){
					...
					Wizard = require('ui/gtablet/wizard/Wizard');
